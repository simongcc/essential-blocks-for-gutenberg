...
function hello_gutenberg_add_meta_box() {
	add_meta_box( 'hello_gutenberg_meta_box', __( 'Hello Gutenberg Meta Box', 'gutenberg-blocks' ), 'hello_gutenberg_metabox_callback', 'post',  array(
...
function hello_gutenberg_metabox_callback( $post ) {
	...
	?>
	<label for="hello_gutenberg_field"><?php _e( 'What\'s your name?', 'gutenberg-blocks' ) ?></label>
...
function hello_gutenberg_api_posts_meta_field() {
	register_rest_route(
		'gutenberg-blocks/v1', '/update-meta', array(
			'methods'  => 'POST',
